// Function to populate the edit modal with student details
var studentId;
function populateEditModal(studentId,firstName,lastName,email,phone,userNumber) {
...
//data binding
  $(document).ready(function () {
    ...
    $('[data-target="#editModal"]').click(function () {
      ...
      populateEditModal(studentId,firstName,lastName,email,phone,userNumber);
    });

    $('[data-target="#deleteModal"]').click(function () {
      studentId = $(this).data("studentid");
      $("#studentIdDelete").val(studentId);
    });
  });
...
$(document).ready(function() {
  $('#deleteButton').click(function() {
    var studentId =  $('#studentIdDelete').val();
    var data = {
      id: studentId,
      firstName:  "",
      lastName:  "",
